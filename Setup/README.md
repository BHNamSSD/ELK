...
### 1 Detection – Alert triggered from Kibana dashboards
### 2 Analysis – Investigate logs and identify attack patterns
### 3 Containment – Determine affected systems/services
### 4 Eradication – Remove threat indicators
### 5 Recovery – Restore normal operations
### 6 Lessons Learned – Improve detection rules
